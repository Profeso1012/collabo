...
function Qc(a,b,c,d){if(b=a.U.a[String(b)]){b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.ka&&g.capture==c){var l=g.listener,x=g.Ha||g.src;g.Da&&uc(a.U,g);e=!1!==l.call(x,d)&&e}}}};function Sc(a,b){if("function"==q(a))b&&(a=ta(a,b));else if(a&&"function"==typeof a.handleEvent)a=ta(a.handleEvent,a);else throw Error("Invalid listener argument");2147483647<Number(1E3)||m.setTimeout(a,1E3)};var w={la:"linux",N:"mac",oa:"mac49",pa:"mac65",qa:"mac88",na:"mac104",za:"mac116",Ma:"mac129",Na:"mac139",K:"win",T:"win_arm64",B:"win49",$:"win64",S:"win110",O:"win110_64",gb:"ios",eb:"android",Lc:"unknown",Ka:"chromeOS"},Tc={name:"unknown",id:0},Uc={name:"brave",id:0},Vc={name:"opera",id:0},Wc={name:"safari",id:0},Xc={name:"samsung",id:0},Yc={name:"ie",id:2},Zc={name:"firefox",id:3},$c={name:"chrome",id:4},ad={name:"EDGE",id:5},ed={name:"EDGIUM",id:5},fd=/(iPhone|iPod|iPad|Android|BlackBerry|IEMobile)/,
gd=[{g:/en_us|en_ca|en_sg|en_ph/,xa:"en"},{g:/en_au|en_hk|en_in|en_ie|en_pk|en_uk/,xa:"en-GB"},{g:/pt_ALL|pt-PT_ALL/,xa:"pt-PT"},{g:/iw_ALL/,xa:"iw"},{g:/pt-BR_ALL|zh-CN_ALL|zh-HK_ALL|zh-TW_ALL|es-419_ALL|no_ALL/,Ub:"_ALL"}];var L={Ob:"gu_expt",ca:"brand",Pb:"clickonceinstalled",Kc:"extra",La:"installdataindex",Tb:"gu_guexpt",jb:"platform",Vb:"standalone",Oa:"statcb",fb:"defaultbrowser",Wb:"system",pb:"win_v",Sb:"mac_v",Rb:"gclid"},hd={wa:"GGRO",ya:[{g:/^GGRO$/,m:"GGRO"},{g:/^GCEA$/,m:"GCEA"},{g:/^MACD$/,m:"MACD"},{g:/^OZZY$/,m:"OZZY"},{g:/^RXSR$/,m:"RXSR"},{g:/^NXHP$/,m:"NXHP"},{g:/^GKPW$/,m:"GKPW"},{g:/^ZNUK$/,m:"ZNUK"},{g:/^PBUL$/,m:"PBUL"},{g:/^KXLH$/,m:"KXLH"},{g:/^BAPC$/,m:"BAPC"},{g:/^LDPL$/,m:"LDPL"},{g:/^LSJR$/,
...
(c=d.match(/\d/)[0]||null)}"no api"===c?this.j="smode_noapi":"0"===c?this.j="smode_unlocked":"2"===c&&(this.j="smode_locked")}else this.j="none";a?(this.f="xp"===this.c||"vista"===this.c?w.B:"win8"===this.c||"win7"===this.c?null!==this.a.match("WOW64")||null!==this.a.match("Win64")?w.O:w.S:null!==this.a.match("WOW64")||null!==this.a.match("Win64")?w.$:w.K,qd(this)):this.f=w.K}lb&&(this.Za(rd(this)),this.f=this.rb(a,b),this.b===Wc&&(this.ra="chrome_file_download_mac_safari"));ob&&(this.f=w.eb);nb&&
(this.f=ob?w.eb:v("CrOS")?w.Ka:w.la);if(od()||pb)this.f=w.gb};function od(){var a=navigator.maxTouchPoints||0,b=window.DeviceMotionEvent||window.DeviceOrientationEvent;a=navigator.userAgent.includes("Macintosh")&&"ontouchend"in document&&0<a&&b;return qb||a}h.Ea=function(){return this.b.id};h.ic=function(){return this.b.name};h.ga=function(a){return a===this.b.name};h.mc=function(){return this.s};
function rd(a){a=a.a.match(/Mac OS X (\d[\._\d]+)/);var b="";a&&(a=(a[1]||a).split("_"),b=a[0]+(a[1]?"."+a[1]:""));return b.toString()}h.ja=function(){return this.o};h.Fb=function(a){this.o=a};h.rb=function(a){if(a){a=rd(this).split(".");a=a[1]?Number(a[1]):0;if(6<=a&&8>=a)return w.oa;if(9===a)return w.pa;if(10===a)return w.qa;if(10<a&&13>a)return w.na;if(13<=a&&15>a)return w.za}return w.N};h.wb=function(){if(-1!==this.a.indexOf("Windows CE"))return Tc;if(-1===this.a.indexOf("PPC")||-1===this.a.indexOf("Smartphone"))return Yc};
function pd(a){return(a=a.a.match(/Windows NT (\d*\.\d*)/))?+a[1]:a}function qd(a){var b=window.navigator.userAgentData;b&&b.getHighEntropyValues(["architecture","bitness","platformVersion"]).then(function(b){if("Windows"===window.navigator.userAgentData.platform){var c=parseInt(b.platformVersion.split(".")[0]);1<=c&&13>c?a.ra="chrome_file_download_win_10":13<=c&&(a.ra="chrome_file_download_win_11","arm"===b.architecture&&"64"===b.bitness&&(a.f=w.T,md({platform:a.f})))}})}h.ia=function(){return this.c};
h.yb=function(){for(var a=C(document.body).getAttribute("data-locale"),b=C(document.documentElement).getAttribute("lang"),c=0;c<gd.length;c++){var d=gd[c].xa,e=gd[c].Ub;if(gd[c].g.test(a)){b=d?d:a.replace(e,"");break}}return b};h.kc=function(){return this.i()+"-"+this.i()};h.Za=function(a){this.v=a};h.oc=function(){return this.v};h.nc=function(){return this.j};h.jc=function(){return this.ra};M.prototype.getChromeFileDownloadNameEvent=M.prototype.jc;M.prototype.getOSModeVariant=M.prototype.nc;
M.prototype.getOSVersion=M.prototype.oc;M.prototype.setOSVersion=M.prototype.Za;M.prototype.getCurrentPlatformBrowser=M.prototype.kc;M.prototype.mapLanguageByLocale=M.prototype.yb;M.prototype.getWindowsVersion=M.prototype.ia;M.prototype.handleIEBrowserVersion=M.prototype.wb;M.prototype.checkOSXPlatform=M.prototype.rb;M.prototype.setMobile=M.prototype.Fb;M.prototype.isMobile=M.prototype.ja;M.prototype.getLang=M.prototype.mc;M.prototype.checkBrowser=M.prototype.ga;M.prototype.getBrowserName=M.prototype.ic;
M.prototype.getBrowserId_=M.prototype.Ea;M.prototype.setPlatformAndVersion=M.prototype.Jb;M.prototype.getPlatform=M.prototype.i;function sd(a,b){this.b={};this.a=[];this.c=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else if(a)if(a instanceof sd)for(c=a.ha(),d=0;d<c.length;d++)this.set(c[d],a.get(c[d]));else for(d in a)this.set(d,a[d])}h=sd.prototype;h.V=function(){td(this);for(var a=[],b=0;b<this.a.length;b++)a.push(this.b[this.a[b]]);return a};h.ha=function(){td(this);return this.a.concat()};
...
h.get=function(a,b){for(var c=a+"=",d=(this.a.cookie||"").split(";"),e=0,f;e<d.length;e++){f=Ga(d[e]);if(0==f.lastIndexOf(c,0))return f.substr(c.length);if(f==a)return""}return b};h.remove=function(a,b,c){var d=n(this.get(a));this.set(a,"",0,b,c);return d};h.ha=function(){return Od(this).keys};h.V=function(){return Od(this).values};
...
P.prototype.buildTag=P.prototype.Ca;P.prototype.buildGlobalExtra=P.prototype.Ba;P.prototype.createAppInfo=P.prototype.Sa;function S(a,b){this.c=new M;this.a={"default":!1,l:null,ba:null};this.b={"default":null,l:null,ba:null};this.h={A:b,l:null,u:null};this.w={A:null,l:null,u:null};this.f=a;this.va()&&(this.w.A=this.c.ia());Rd(this);Sd(this)}
...
h.Ja=function(a){this.a.ba=a};h.ta=function(){return null!==this.a.ba?this.a.ba:null===this.a.l||this.h.u?this.a["default"]:this.a.l};function Sd(a){var b=a.h.A;null!==a.h.u?b=a.h.u:null!==a.h.l&&(b=a.h.l);a.b["default"]=a.va()&&b!==w.B?!0:!1}h.Ib=function(a){this.h.A=a;this.va()&&(this.w.A=a)};h.bb=function(a){this.b.ba=a};h.Cb=function(a){"undefined"===typeof a?this.b.l=null:this.b.l="1"===a};h.ua=function(){return null!==this.b.ba?this.b.ba:null===this.b.l||this.h.u?this.b["default"]:this.b.l};
...
function U(a){K.call(this);this.c=new M;this.b=new P;this.userFlow=new S(a,this.c.i());this.D=(new xd(location.href)).a;this.o=this.userFlow.ua();this.a=a;this.v=this.c.s;this.j=this.C=null;this.L="";this.W=!1;this.R=kd.wa;this.X="";this.I=null;a=[];var b=0;for(c in jd)a[b++]=c;this.ma=a[1];this.fa=this.Y=this.H=this.da=!1;this.s=null;this.ea=!1;this.J=this.c.ia();this.Z=this.Ra=!1;this.G="";this.F=!1;this.chosenVariant=this.M="";this.f=I(document.body,"experiment")?JSON.parse(I(document.body,"experiment")):
null;var c=this.D.get(L.Wb);var d=T(L.jb);a=T(L.Ob);b=T(L.Vb);var e=this.D.get(L.pb),f=this.D.get(L.Sb),g=this.D.get(L.Oa),l=this.D.get(L.fb);e&&(this.J=e,this.userFlow.Db(e));d.length&&Va(d[0])&&(d=d[0],!this.J||"xp"!==this.J&&"vista"!==this.J?this.userFlow.P(d):this.userFlow.P(d?d:w.B));this.userFlow.i()===w.N&&f&&("106"===f||"107"===f||"108"===f?this.userFlow.P(w.oa):"109"===f?this.userFlow.P(w.pa):"1010"===f?this.userFlow.P(w.qa):("1011"===f||"1012"===f)&&this.userFlow.P(w.na));this.userFlow.h.A===
w.N&&"maxTouchPoints"in navigator&&0<navigator.maxTouchPoints&&(this.userFlow.P(w.gb),this.c.Fb(!0));this.X=this.D.get(L.La);this.userFlow.Bb(this.X);this.userFlow.Cb(g);l&&this.userFlow.Ja("1"===l);this.Ra=!!g;Wd(this);this.C=T(L.Tb);this.userFlow.i().includes("mac")&&"stablechannel"===this.a?this.L=Ud.mac:this.L=Ud[this.a];this.W=Vd[this.a];"canarychannel"===this.a?this.R=kd.Qb:c&&(this.R=Xd(kd,c));this.I=this.D.get(L.ca);a.length?this.s=a:this.f&&(this.s=[this.f.key,this.f.value,this.f.time]);
this.ea=0<b.length&&"1"===b[0];J(window,"load",this.zb,!1,this)}U.prototype=da(K.prototype);U.prototype.constructor=U;if(ja)ja(U,K);else for(var Yd in K)if("prototype"!=Yd)if(Object.defineProperties){var Zd=Object.getOwnPropertyDescriptor(K,Yd);Zd&&Object.defineProperty(U,Yd,Zd)}else U[Yd]=K[Yd];U.cb=K.prototype;h=U.prototype;
h.zb=function(){this.G="download";this.j=this.b.Sa(this.L,this.W,this.R,$d(this),this.s);location.href.match(".*#eula.*")?ae(this,"eula"):location.href.match(".*next-steps.*")?ae(this,"thankyou"):ae(this,"index")};h.Xa=function(a){this.userFlow.Ja(a);Wd(this)};h.ab=function(a){this.userFlow.bb(a);Wd(this)};h.Ya=function(a){this.ma=a};h.ub=function(){return this.userFlow.i()+"-"+this.a.replace("channel","")};
h.tb=function(){var a=ba(T(L.ca)).next().value,b=this.userFlow.i(),c=this.a.replace("channel","");c=Td[b+"_"+c];if(!ld.includes(b)||!a)return c;var d=ba(c.split("?"));c=d.next().value;d=d.next().value;a="web-brand-"+a;b="android"===b?"pcampaignid="+a:"pt=9008&ct="+a+"&mt=8";return""+c+(d?"?"+d+"&"+b:"?"+b)};h.ja=function(){return this.c.ja()};h.Kb=function(a){this.userFlow.Ib(a);Wd(this);this.zb()};h.ia=function(){return this.J};
function V(a,b,c){var d=void 0===d?!1:d;var e=a.a,f=a.b;Ld(e,b)||!d?c&&c.length&&(Md(e,b,c),Ad(a,e)):(e=new N(f),(Ld(e,b)||d)&&c&&c.length&&(Md(e,b,c),b=Bd(e.toString()),a.b=b))}function $d(a){var b="";if(a.H){var c=a.Y?"x64":"x86";a.fa&&(c="arm64");("devchannel"===a.a||"betachannel"===a.a||"canarychannel"===a.a||a.H&&a.userFlow.i()!==w.B)&&(c+="-statsdef_1");c&&(b+="&ap="+c)}a.f&&a.f.brand?b+="&"+L.ca+"="+a.f.brand:a.I&&(b+="&"+L.ca+"="+a.I);return b=b+"&"+L.La+"="+be(a)}
...
function De(a){a=void 0===a?{}:a;a=void 0===a.aa?!0:a.aa;J(window,"load",this.tc,!1,this);this.aa=a;a=this.vc.bind(this);nd.platformClientHintDetection||(nd.platformClientHintDetection=[]);nd.platformClientHintDetection.push(a);this.a=new U("stablechannel");this.c=new M;this.$b=window;this.R=Jb("js-eula-close");this.H=D("js-download");this.kb=null;this.f=Jb("js-eula-dialog");this.D=C("js-eula-modal");this.Aa=C("find-installer-modal");this.mb=Jb("js-eula-overlay");this.s=C("js-chrome-os-modal");this.b=
this.a.userFlow.i();this.b!==w.Ka||this.s||(this.a.userFlow.P(w.la),this.b=this.a.userFlow.i());this.W=C("js-default-cb");this.Zb=C("js-linux-ubuntu");this.Yb=C("js-linux-fedora");this.C=D("js-default-cb-sdf");this.ea=C("js-stats-cb");this.j=D("js-stats-cb-sdf");this.Xb=D("js-accept-install");this.ob=C("js-throbber");this.o=D("js-linux-distro-options");this.F=this.a.userFlow.Ga();this.X=C("js-eula-content");this.da=C("js-other-platform-modal");this.ma=D("js-download-current");this.lb=D("js-other-option");
this.Z=!1;this.ib=window.sessionStorage?window.sessionStorage.getItem("linuxDistributionID"):null;this.hb=Jb("js-hero");this.G={};this.I=this.a.userFlow.w.A;this.Y="win8"===this.I||"win10"===this.I;this.M=C("js-simplified-download");this.v=C("js-download-hero");this.nb=C("js-thank-you-o");this.fa=D("js-thank-you-n");this.Nb=C("js-thank-you-steps");this.L=D("js-os-specific");Ee(this)}h=De.prototype;
...
a.chosenVariant&&"1"===a.chosenVariant.toString());if(this.M){a=D(Y(this),this.M);b=Z(this);var c=a.length;if(b!=w.la)for(;c--;)0!==D("default-browser-opt",a[c]).length&&this.Y||(G(a[c],"show"),F(a[c],X),F(a[c].parentNode,X));b==w.K&&(a=this.v.querySelector(".chr-cta__extra-content"))&&(a.classList.add("chr-cta__extra-content--visible"),this.v.classList.add("chr-cta__button--extra-content"));Fe(this)}};
function Ee(a){if(!Ge(a))for(var b=a.H.length;b--;)G(a.H[b],"show");a.aa&&a.v&&He(a,a.v)&&cc(a.v,'{"click": {\n            "event": "chrome_file_download",\n            "module_name": true,\n            "section_header": true,\n            "link_type": true,\n            "link_url": true,\n            "link_text": true,\n            "file_name": "'+Ie(a)+'"\n          }}');a.L.length&&Je(a);if(a.D){b=a.H.length;if(a.a.ja())for(;b--;)J(a.H[b],"click",a.gc,!1,a);else for(;b--;)J(a.H[b],"click",a.Gc,
!1,a);J(a.mb,"click",a.Ta,!1,a);J(window,"resize",a.Ab,!1,a);J(a.R,"click",a.Ta,!1,a);J(a.W,"change",a.Lb,!1,a);if(null!==a.C)for(b=a.C.length;b--;)J(a.C[b],"change",a.Lb,!1,a);J(a.ea,"change",a.Mb,!1,a);if(a.aa){J(a.ea,"change",a.sa.bind(a),!1,a);J(a.W,"change",a.sa.bind(a),!1,a);if(null!==a.j)for(b=a.j.length;b--;)J(a.j[b],"change",a.sa.bind(a),!1,a);J(a.Zb,"change",a.sa.bind(a),!1,a);J(a.Yb,"change",a.sa.bind(a),!1,a)}if(null!==a.j)for(b=a.j.length;b--;)J(a.j[b],"change",a.Mb,!1,a);Array.prototype.forEach.call(a.Xb,
function(b){J(b,"click",a.qb,!1,a)});J(a.a,"download_preparing",a.xb,!1,a);J(a.a,"download_starting",a.xb,!1,a);for(b=a.o.length;b--;)a.ib&&a.o[b].id===a.ib&&(a.o[b].checked=!0),a.o[b].checked&&a.a.Ya(a.o[b].value),J(a.o[b],"click",a.uc,!1,a);for(b=a.ma.length;b--;)J(a.ma[b],"click",function(){Ke(this);Le(this)},!1,a);for(b=a.lb.length;b--;)J(a.lb[b],"click",a.Hc,!1,a);a.a.ja()||"#eula"!==location.hash||Ge(a)||Le(a)}if(a.hb){b=D(Y(a),a.hb);for(var c=b.length;c--;)G(b[c],"show")}a.nb&&Me(a);Ne(a)}
...
function Ke(a){var b=D("os-"+Z(a),a.D),c=a.F?["show",a.F]:["show"];a.I&&c.push("origin-"+a.I);for(var d=b.length;d--;)Vb(b[d],c),F(b[d],Ce);b=D(Y(a),a.D);for(c=b.length;c--;)H(b[c],"show"),F(b[c],Ce);H(a.X,"show");F(a.X,Ce);Vb(a.da,["show",a.b]);F(a.da,Ce);a.s&&(H(a.s,"show"),F(a.s,Ce));if(a=a.f)if(oc(a)){if(a.U){var e=a.U;a="keydown".toString();b=0;for(var f in e.a)if(!a||f==a){c=e.a[f];for(d=0;d<c.length;d++)++b,rc(c[d]);delete e.a[f];e.b--}}}else if(f=Bc(a))for(e in a=0,b="keydown".toString(),
f.a)if(!b||e==b)for(c=f.a[e].concat(),d=0;d<c.length;++d)Gc(c[d])&&++a}function Ne(a){a.W.checked=a.a.userFlow.ta();if(null!==a.C)for(var b=a.C.length;b--;)a.C[b].checked=a.a.userFlow.ta();a.ea.checked=a.a.userFlow.ua();if(null!==a.j)for(b=a.j.length;b--;)a.j[b].checked=a.a.userFlow.ua()}
function Le(a,b){b=void 0===b?"eula":b;a.b=a.a.userFlow.i();a.F=a.a.userFlow.Ga();var c=!1,d=["show"];"eula"===b&&a.s&&a.b===w.Ka&&(b="chrome-os");a.F&&d.push(a.F);a.Y&&d.push("origin-"+a.I);Ne(a);if("eula"===b){c=!0;var e=a.X}else e="chrome-os"===b?a.s:a.da;G(e,"show");F(e,X);var f=D("os-"+Z(a),e);f&&r(f,function(a){Ub(a,d);F(a,X)});a.mb.style.height=Mc(Nb(),!0);var g=Jb(Y(a),e);g&&(G(g,"show"),F(g,X));G(a.D,"show");a.Ab();"eula"===b?r(f,function(b){ef(a,c,b)}):ef(a,c,e);J(a.f,"keydown",a.sc.bind(a),
!1,a)}
...
h.qb=function(a,b){b=void 0===b?!1:b;a.preventDefault();this.J=a.target;this.J.setAttribute("disabled","disabled");!1===ff(this,a)&&(this.a.Xa(!1),this.a.ab(!1));if(this.aa){var c=this.c.ra;c&&gf(this,c);b||gf(this,"chrome_file_download")}this.a.Ua()};h.xb=function(a){switch(a.type){case "download_preparing":G(this.ob,"show");break;case "download_starting":H(this.ob,"show"),this.J&&this.J.removeAttribute("disabled")}};
...
function Y(a){return"channel-"+a.a.ub()}function Z(a){switch(a.b){case w.K:case w.T:case w.B:case w.$:case w.S:case w.O:a=w.K;break;case w.N:case w.oa:case w.pa:case w.qa:case w.na:case w.za:case w.Ma:case w.Na:a=w.N;break;default:a=a.b}return a}
function ef(a,b,c){var d={"aria-hidden":"false","aria-labelledby":"dialog-o-h-os-"+Z(a),"aria-describedby":"dialog-o-h-os-"+Y(a)};a.G=C("js-accept-install--"+Z(a));b||(Z(a)===w.N&&a.c.ga(Zc.name)?a.G=a.f:(b=(c||document).getElementsByTagName("A"),d={"aria-hidden":"false","aria-labelledby":"dialog-o-h-os-header-other","aria-describedby":""},a.G=b[b.length-1]));F(a.f,d);a.f.focus()}
...
function Fe(a){var b=document.querySelectorAll(".chr-homepage-hero__simplified");Array.prototype.forEach.call(document.querySelectorAll(".chr-homepage-hero__download .chr-cta__button--download"),function(a,b){0<b&&(a.id=a.id+"_"+b)});1<b.length&&[].concat(b instanceof Array?b:ca(ba(b))).forEach(function(b,d){if(0<d){b.id=b.id+"_"+d;var c=D(Y(a),b),f=Z(a),g=c.length;if(f!=w.la)for(;g--;)0!==D("default-browser-opt",c[g]).length&&a.Y||(G(c[g],"show"),F(c[g],X),F(c[g].parentNode,X));f==w.K&&(c=a.v.querySelector(".chr-cta__extra-content"))&&
(c.classList.add("chr-cta__extra-content--visible"),a.v.classList.add("chr-cta__button--extra-content"))}})}
function Me(a){var b=!1,c=!1,d=!1,e=null;switch(a.b){case w.N:b=!0;(c=a.c.ga(Wc.name))&&(e=C("js-safari-download-help"));break;case w.K:case w.$:case w.T:"win10"===a.c.ia()&&(a.c.ga(ad.name)||a.c.ga(ed.name))&&(b=!0),(c=!(window.external&&window.external.getHostEnvironmentValue))&&(e=C("js-smode-download-help")),d=!0}0===a.fa.length&&(b=!1);var f=Jb("os-"+Z(a),a.Nb);f&&G(f,"show");if(b){for(b=a.fa.length;b--;)G(a.fa[b],"show");hf(d,f)}else G(a.nb,"show");c&&e&&H(e,"hide")}
...
l.offsetParent)return!1}}return!0}catch(x){return console.error(x),!1}}function He(a,b){a.b=a.a.userFlow.i();return([w.N,w.oa,w.pa,w.qa,w.na,w.za,w.Ma,w.Na].includes(a.b)||jf(a))&&"simplified"===b.getAttribute("data-download-simplified")?!0:!1}function jf(a){return[w.B,w.S,w.O,w.K,w.$,w.T].includes(a.b)}function gf(a,b){var c={};Be(a.J,(c.event=b,c.file_name=Ie(a),c))}function Ie(a){return I(document.body,"channel")+"-"+a.b}function cf(a,b,c){var d={};Be(a,(d.event=b,d.checkbox_text=c,d))}
function df(){setTimeout(function(){H(document.body,"chr-modal-active")},300)};y&&!wb(10)&&document.attachEvent?document.attachEvent("onreadystatechange",function(){"complete"===document.readyState&&new De({aa:!1})}):J(document,"DOMContentLoaded",function(){y&&!wb(11)?new De({aa:!1}):new De});}).call(window);
